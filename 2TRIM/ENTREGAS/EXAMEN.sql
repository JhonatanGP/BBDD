...
SELECT  COUNT(*) FROM AVANCES_LINEAS_FABRICACION WHERE TRIM(TO_CHAR(FECHA,'DAY'))  = 'DOMINGO';

--2.10
SELECT *FROM MAQUINAS;
SELECT DECODE(LENGTH(T_FABRICACION),2,'POCO',3,'NORMAL',4,'MUCHO'),T_FABRICACION FROM MAQUINAS;
...
SELECT NOMBRE FROM MAQUINAS WHERE REF = (SELECT ID_MAQUINA FROM AVANCES_LINEAS_FABRICACION WHERE ESTADO = 'PUESTA A PUNTO' AND FECHA = '11-11-2023' AND HORA = '20:05');
