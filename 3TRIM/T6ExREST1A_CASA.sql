...
set serveroutput on;
/*### Ejercicio 1
Crea una función que se llame calculaDineroComandasDias que reciba como parámetro un día (formato día, mes y año, tal y 
como está el campo fecha de comandas en base de datos) y devuelva el importe total que se ha ganado ese día.
...
is
    totalCobrado platos.precio%type; -- guardo precio en esta variable
...
begin
    dbms_output.put_line(calculaDineroComandasDias('23/03/21'));
end;
/
...
create or replace procedure incluyeComanda(
    pMesa comandas.mesa%type,
    pNombreCliente clientes.nombre%type,
    pNombrePlato platos.nombre%type)
is
...
/*### Ejercicio 3
Crea un procedimiento que se utilice para borrar comandas que se llame eliminarComanda, que reciba por parámetro el id 
de una comanda y elimine dicho registro de la tabla. Una vez se borre, mostrar el mensaje "Comanda eliminada satisfactoriamente".
Ten en cuenta que:
