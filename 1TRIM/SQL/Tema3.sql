...
ALTER TABLE PIEZAS ADD CONSTRAINT CHK_COD CHECK(REGEXP_LIKE(CODIGO,'P,[0-9]{3},[A-Z]'));
...
ALTER TABLE DOC ADD CONSTRAINT PK_DNI PRIMARY KEY(DNI);
ALTER TABLE DOC MODIFY DNI CHAR(9);
ALTER TABLE DOC ADD CONSTRAINT CHK_DNI CHECK(REGEXP_LIKE(DNI,'[0-9]{8},[A-Z]'));
ALTER TABLE DOC ADD TFN NUMBER;
ALTER TABLE DOC ADD CONSTRAINT CHK_NUMBER CHECK(REGEXP_LIKE(TFN,'0034,[0-9]{9}'));
